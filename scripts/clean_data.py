...
def clean_source(spec: SourceSpec, global_seen: set[str]) -> dict:
    ...
    for candidate in extract_candidates(spec, raw_text):
        ...
        # - bible_shona: trusted source ΓÇö skip langdetect and keep cleaned lines
        # - opus_en_sn: parallel file ΓÇö we already extracted the Shona column, skip langdetect
